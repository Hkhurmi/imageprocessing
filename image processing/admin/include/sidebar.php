      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <li class="sub-menu">
		   ...
		   <li class="sub-menu">
            <a href="javascript:;" class="">
                          <i class="icon_plus-box"></i>
                          <span>Products Partner</span>
                          <span class="menu-arrow arrow_carrot-right"></span>
                      </a>
            <ul class="sub">
              <li><a class="" href="partner.php">Add Partner</a></li>
              <li><a class="" href="managepartner.php">Manage Partner</a></li>
            </ul>
          </li>
         ...
         <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a class="" href="#">Order Report</a></li>
